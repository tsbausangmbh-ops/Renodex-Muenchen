...
const districts: DistrictData[] = [
  { slug: "allach", name: "Allach", isCity: false, localInfo: "Allach liegt im Nordwesten Münchens und zeichnet sich durch viele Einfamilienhäuser und Siedlungen aus den 1950er-80er Jahren aus.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "aubing", name: "Aubing", isCity: false, localInfo: "Aubing ist Münchens westlichster Stadtteil mit vielen Reihenhäusern und Neubaugebieten.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "berg-am-laim", name: "Berg am Laim", isCity: false, localInfo: "Berg am Laim verbindet Altbau-Charme mit modernen Wohnanlagen.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "bogenhausen", name: "Bogenhausen", isCity: false, localInfo: "Bogenhausen zählt zu Münchens exklusivsten Wohnlagen mit historischen Villen.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "feldmoching", name: "Feldmoching", isCity: false, localInfo: "Feldmoching im Münchner Norden bietet ländlichen Charakter mit vielen Einfamilienhäusern.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "hadern", name: "Hadern", isCity: false, localInfo: "Hadern liegt im Südwesten Münchens, geprägt von Wohnsiedlungen der Nachkriegszeit.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "haidhausen", name: "Haidhausen", isCity: false, localInfo: "Haidhausen ist bekannt für seine Altbauten und das Franzosenviertel.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "laim", name: "Laim", isCity: false, localInfo: "Laim verbindet zentrale Lage mit Wohnqualität.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "lehel", name: "Lehel", isCity: false, localInfo: "Das Lehel ist Münchens ältester Stadtteil mit historischen Gebäuden.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "maxvorstadt", name: "Maxvorstadt", isCity: false, localInfo: "Die Maxvorstadt ist das Kunst- und Wissenschaftsviertel Münchens mit vielen Altbauten.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "milbertshofen", name: "Milbertshofen", isCity: false, localInfo: "Milbertshofen ist geprägt von Industrie und Wohngebieten im Münchner Norden.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "moosach", name: "Moosach", isCity: false, localInfo: "Moosach ist unser direktes Nachbarviertel im Münchner Westen.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "neuhausen", name: "Neuhausen", isCity: false, localInfo: "Neuhausen-Nymphenburg ist eines der beliebtesten Wohnviertel Münchens.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "nymphenburg", name: "Nymphenburg", isCity: false, localInfo: "Nymphenburg ist geprägt vom berühmten Schloss und gehobenen Wohnlagen.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "obermenzing", name: "Obermenzing", isCity: false, localInfo: "Obermenzing ist unser Firmensitz.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "obergiesing", name: "Obergiesing", isCity: false, localInfo: "Obergiesing im Münchner Süden bietet eine Mischung aus Alt- und Neubauten.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "pasing", name: "Pasing", isCity: false, localInfo: "Pasing ist ein eigenständiges Zentrum im Münchner Westen.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "perlach", name: "Perlach", isCity: false, localInfo: "Perlach im Münchner Südosten ist bekannt für Neuperlach mit Hochhäusern.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "ramersdorf", name: "Ramersdorf", isCity: false, localInfo: "Ramersdorf-Perlach liegt im Südosten Münchens.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "schwabing", name: "Schwabing", isCity: false, localInfo: "Schwabing ist bekannt für Altbauten, Jugendstil und anspruchsvolle Architektur.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "schwanthalerhoehe", name: "Schwanthalerhöhe", isCity: false, localInfo: "Die Schwanthalerhöhe liegt zentral nahe der Theresienwiese.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "sendling", name: "Sendling", isCity: false, localInfo: "Sendling im Münchner Süden ist ein traditionelles Wohnviertel.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "solln", name: "Solln", isCity: false, localInfo: "Solln ist eine gehobene Wohngegend im Münchner Süden mit vielen Villen.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "trudering", name: "Trudering", isCity: false, localInfo: "Trudering-Riem im Münchner Osten bietet eine Mischung aus Alt und Neu.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "riem", name: "Riem", isCity: false, localInfo: "Riem im Münchner Osten ist bekannt für die Messestadt und moderne Neubauviertel rund um das ehemalige Flughafengelände.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "untermenzing", name: "Untermenzing", isCity: false, localInfo: "Untermenzing liegt direkt neben unserem Firmensitz in Obermenzing.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "garching", name: "Garching", isCity: true, localInfo: "Garching ist bekannt für die TU München und moderne Architektur.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "germering", name: "Germering", isCity: true, localInfo: "Germering ist eine große Kreisstadt westlich von München.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "ottobrunn", name: "Ottobrunn", isCity: true, localInfo: "Ottobrunn liegt südöstlich von München.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "unterhaching", name: "Unterhaching", isCity: true, localInfo: "Unterhaching ist eine wohlhabende Gemeinde südlich von München, bekannt für moderne Wohngebiete und die Geothermieanlage.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "unterschleissheim", name: "Unterschleißheim", isCity: true, localInfo: "Unterschleißheim liegt nördlich von München.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "haar", name: "Haar", isCity: true, localInfo: "Haar liegt östlich von München und ist eine familienfreundliche Gemeinde mit vielen Einfamilienhäusern und Reihenhaussiedlungen.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "taufkirchen", name: "Taufkirchen", isCity: true, localInfo: "Taufkirchen im Münchner Süden bietet eine Mischung aus Wohn- und Gewerbegebieten mit modernen Neubauten.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "graefelfing", name: "Gräfelfing", isCity: true, localInfo: "Gräfelfing westlich von München ist eine gehobene Villenvorstadt mit großzügigen Grundstücken und hochwertigen Dächern.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "planegg", name: "Planegg", isCity: true, localInfo: "Planegg liegt südwestlich von München und ist bekannt für den Biotech-Standort Martinsried und gepflegte Wohngebiete.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "pullach", name: "Pullach", isCity: true, localInfo: "Pullach im Isartal südlich von München ist eine wohlhabende Gemeinde mit Villen und historischen Gebäuden entlang der Isar.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "gruenwald", name: "Grünwald", isCity: true, localInfo: "Grünwald an der Isar ist eine der wohlhabendsten Gemeinden Deutschlands mit exklusiven Villen und Anwesen.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "ismaning", name: "Ismaning", isCity: true, localInfo: "Ismaning nördlich von München ist ein Medienstandort mit modernen Bürogebäuden und gewachsenen Wohngebieten.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "oberschleissheim", name: "Oberschleißheim", isCity: true, localInfo: "Oberschleißheim ist bekannt für das Schloss Schleißheim und liegt nördlich von München mit vielen Wohnsiedlungen.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "vaterstetten", name: "Vaterstetten", isCity: true, localInfo: "Vaterstetten östlich von München ist eine der größten Gemeinden im Landkreis Ebersberg mit vielen Einfamilienhäusern.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "poing", name: "Poing", isCity: true, localInfo: "Poing östlich von München wächst stark mit modernen Neubaugebieten und familienfreundlichen Siedlungen.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "olching", name: "Olching", isCity: true, localInfo: "Olching westlich von München liegt an der Amper und bietet eine Mischung aus Altbestand und Neubaugebieten.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "groebenzell", name: "Gröbenzell", isCity: true, localInfo: "Gröbenzell liegt direkt westlich von München und ist eine kompakte Wohngemeinde mit vielen Einfamilienhäusern.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] },
  { slug: "kirchheim", name: "Kirchheim", isCity: true, localInfo: "Kirchheim bei München östlich der Landeshauptstadt ist eine wachsende Gemeinde mit Neubaugebieten und gewachsenen Ortsteilen.", commonIssues: ["Wärmepumpen-Nachrüstung", "Photovoltaik-Installation", "Energetische Modernisierung"] },
  { slug: "aschheim", name: "Aschheim", isCity: true, localInfo: "Aschheim östlich von München ist ein bedeutender Gewerbestandort mit modernen Büro- und Wohngebäuden.", commonIssues: ["Mauerwerksabdichtung bei Altbauten", "Türenaustausch", "Sanitärinstallation im Bad"] },
  { slug: "feldkirchen", name: "Feldkirchen", isCity: true, localInfo: "Feldkirchen bei München östlich der Stadt bietet eine gute Verkehrsanbindung und vielfältige Wohn- und Gewerbebebauung.", commonIssues: ["Sanierungsbedarf bei älterer Haustechnik", "Elektro- und Sanitärinstallation im Altbau", "Energetische Sanierung"] },
  { slug: "neubiberg", name: "Neubiberg", isCity: true, localInfo: "Neubiberg südöstlich von München ist bekannt für die Universität der Bundeswehr und gepflegte Wohngebiete.", commonIssues: ["Badsanierung in bestehenden Wohnungen", "Modernisierung der Heizungsanlage", "Malerarbeiten nach Umbau"] },
  { slug: "putzbrunn", name: "Putzbrunn", isCity: true, localInfo: "Putzbrunn südöstlich von München ist eine ruhige Wohngemeinde mit überwiegend Einfamilienhäusern und Reihenhäusern.", commonIssues: ["Komplettsanierung bei Eigentumsübernahme", "Bodenverlegung nach Entkernung", "Elektroinstallation nach aktuellem Standard"] }
];
