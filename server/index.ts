...
const VALID_SITEMAP_ROUTES = new Set(['/', '/barrierefreiheit', '/datenschutz', '/faq', '/impressum', '/kontakt', '/leistungen', '/leistungen/dachreparatur', '/leistungen/dachrinnen', '/leistungen/dachsanierung', '/leistungen/flachdach', '/leistungen/spenglerei', '/leistungen/steildach', '/preise']);
