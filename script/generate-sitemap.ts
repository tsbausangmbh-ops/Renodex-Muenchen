...
const STATIC_ROUTES: { path: string; priority: string; changefreq: string }[] = [
  ...
  { path: "/sofort-hilfe", priority: "0.9", changefreq: "weekly" },
  { path: "/wasserschaden", priority: "0.8", changefreq: "weekly" },
  { path: "/heizung-ausfall", priority: "0.8", changefreq: "weekly" },
  { path: "/sanierung-reparatur", priority: "0.8", changefreq: "weekly" },
  { path: "/komplettsanierung-kosten", priority: "0.8", changefreq: "monthly" },
  { path: "/waermepumpe-photovoltaik", priority: "0.8", changefreq: "monthly" },
