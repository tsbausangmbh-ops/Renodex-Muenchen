        ...
        <section className="py-8 bg-white dark:bg-zinc-900">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="prose prose-sm max-w-none text-muted-foreground">
              ...
              <p>
                Als <strong className="text-foreground">Dachdecker-Meisterbetrieb ([Gründungsjahr folgt]) in München</strong> reparieren wir seit über 25 Jahren Dächer aller Art. Von der kleinen <strong className="text-foreground">Dachreparatur</strong> bis zur umfassenden Instandsetzung – wir arbeiten schnell, sauber und immer zum vereinbarten <strong className="text-foreground">Festpreis</strong>.
              </p>
              <p>
