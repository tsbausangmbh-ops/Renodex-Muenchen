      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-2">
            <Handshake className="w-6 h-6 text-marine" />
            <h2 className="text-xl md:text-2xl font-bold">Unser Partnernetzwerk in München</h2>
          </div>
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
            Wir arbeiten mit Fachfirmen aus Sanitär, Heizung, Klima und Elektro zusammen – für effiziente Abläufe aus einer Hand.
          </p>
        </div>
