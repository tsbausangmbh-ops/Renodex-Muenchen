...
function generateDistrictContent(district: DistrictConfigBase): DistrictContent {
  ...
  return {
    ...
    localExpertise: `${district.localInfo} Renodex koordiniert als Partnernetzwerk aus Fachfirmen die Sanierung von Haus und Wohnung in ${district.name} – von der Elektroinstallation über Sanitär und Heizung bis zur Komplettsanierung. Besonders häufig geht es dabei in ${district.name} um: ${district.commonIssues.join(", ")}. Jede Immobilie hat ihre eigene Geschichte, und genau deshalb beginnt jede Zusammenarbeit mit einer ehrlichen Einschätzung: Was ist wirklich nötig, und was kann warten?`,
    ...
    whyChooseUs: `Warum entscheiden sich Hausbesitzer und Wohnungseigentümer in ${district.name} für Renodex? Über unser Partnernetzwerk aus Fachfirmen koordinieren wir alle Gewerke Ihrer Sanierung aus einer Hand – Sie haben einen Ansprechpartner statt vieler Einzelhandwerker. Wir sprechen offen über das, was zu tun ist, und über das, was warten kann. Kein Verkaufsdruck, sondern eine Entscheidung, die Sie in Ruhe treffen können.`,

    // NLP: Digitale Erreichbarkeit statt Notdienst-Dringlichkeit
    emergencyService: `Bei akutem Handlungsbedarf – etwa Wasserschaden oder Heizungsausfall – erreichen Sie Renodex digital: ein Foto oder eine kurze Videoaufnahme des Problems reicht meist, damit wir die Lage einschätzen können. Für ${district.name} besprechen wir die nächsten Schritte mit Ihnen schriftlich per E-Mail, damit Sie in Ruhe nachlesen können.`,

    // NLP: Qualitätsversprechen + Abschluss
    qualityPromise: `Renodex steht für koordinierte Sanierung aus einer Hand in ${district.name}: ein Partnernetzwerk aus Fachfirmen und ein Ansprechpartner für alle Gewerke Ihrer Sanierung. Nach Abschluss der Arbeiten erhalten Sie eine vollständige Dokumentation. Kontaktieren Sie uns für eine kostenlose, unverbindliche digitale Erstberatung – wir nehmen uns Zeit für Ihr Anliegen und zeigen Ihnen ehrlich, welche Optionen Sie haben.`
  };
}
