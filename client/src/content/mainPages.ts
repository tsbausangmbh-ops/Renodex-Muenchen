...
export const mainPagesKeywords: Record<string, MainPageKeywords> = {
  ...
  notdienst: {
    ...
    secondaryKeywords: [
      ...
      "Sanierung ohne Besichtigungstermin München",
      "Wasserschaden München schnelle Hilfe",
      "Sturmschaden München schnelle Hilfe",
      ...
      "Schnelle Reaktion Sanierung München",
      "Sanierung Erstberatung digital München"
    ],
    metaTitle: "Digitale Erstberatung – Ihr Anliegen, unsere Lösung | Renodex",
    metaDescription: "Wasserschaden, Sturmschaden, Heizungsausfall oder Sanierungsvorhaben in München? Renodex meldet sich zeitnah mit den nächsten Schritten – ohne Besichtigungstermin.",
    keywords: "digitale Erstberatung München, Wasserschaden München, Sturmschaden München, Heizungsausfall München, Rohrbruch München, Komplettsanierung Anfrage München, schnelle Hilfe Sanierung München"
  },
  faq: {
    slug: "/faq",
    name: "FAQ & Preise",
  ...
  "ueber-uns": {
    ...
    secondaryKeywords: [
      ...
      "Handwerkskammer München Sanierung",
      "Zertifizierter Fachbetrieb München",
      "Erfahrenes Sanierungsunternehmen München",
      "Qualität Sanierung München",
      "Zuverlässiger Sanierungsbetrieb München",
