...
export const mainPagesKeywords: Record<string, MainPageKeywords> = {
  ...
  notdienst: {
    slug: "/sofort-hilfe",
    name: "Schnelle Hilfe",
    mainKeyword: "Wasserschaden Sanitär München",
    secondaryKeywords: [
      ...
      "Rohrbruch München",
      "Wasserschaden Reparatur München",
      "Sanitär Reparatur schnell München",
      "Heizung ausgefallen München",
      "Leitung undicht München",
      "Sanitär Handwerker schnell München",
      "Wasserschaden Sanierung München",
      "Notreparatur Sanitär München",
      "Heizungsnotdienst München",
      "Wasserschaden Versicherung München",
      "Rohrbruch Sanierung München",
      "Sanitär Schaden dokumentieren München",
      "Heizung reparieren München",
      "Sanitär Soforthilfe München",
